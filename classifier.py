...
def train_classifier(small_train=True,barlow=True):
    ...
    learning_rate = 0.0005440964144419005
    momentum_term = 0.26074772224684506
    ...
    classifier_model = ClassifierModel(num_features=2048, num_classes=1)
    ##
    ...
    validation_loader=DataLoader(validation_dataset, batch_size=batch_size, shuffle=True, num_workers=8)
    ...
    for epoch in range(num_epochs):  # Loop over the dataset multiple times
        ...
        writer.add_scalar("Learning_rate", classification_optimizer.param_groups[0]["lr"], epoch)
