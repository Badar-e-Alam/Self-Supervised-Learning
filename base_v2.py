...
class ClassifierModel(nn.Module):
    def __init__(self, num_classes):
            ...
            weights=torch.load("base_model/model_1244.pt",map_location=torch.device('cpu'))
            model.load_state_dict(weights, strict=False)  # Add strict=False to handle mismatched keys
